...
2026-08-31 未裁定21件の棚卸し(オーナー承認): 制度導入前(8/2-13)の12件は「裁定対象外(pre-verdict era)」として一括クローズ扱い(b6503b9a, 09957da4, db8e54e5, 8e096d63, a385f876, 02a434ad, 4d048081, eceb49cb, 1adf234e, 8bc7ce00 ほか)。他セッション発8件のうち20USD超2件(7d4aaedd, 4e72c8ce)のみオーナー裁定対象として要約提示。c19fd8edは抜き打ち枠(任意)。
