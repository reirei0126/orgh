...
MOCK_ENV_VARS = [
    ...
    "MOCK_INFRA_FAIL_TIMES", "MOCK_REVIEWER_FAIL_TIMES", "MOCK_CAPABILITY_BLOCK",
    "MOCK_CRITERIA_JSON",
    "MOCK_PERSONA_REJECT_ONCE", "MOCK_PERSONA_ALWAYS_FAIL",
    "MOCK_PERSONA_NO_EVIDENCE", "MOCK_REVIEWER_AC_VERDICTS",
]
